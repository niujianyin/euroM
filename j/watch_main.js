...
__inline('./lb_ms/viewModules.js');
__inline('./lb_ms/setCharts.js');
...
$(function () {
  ...
  headData.set(matchId, function (teamInfo) {
    ...
    ajaxData.mvpData(pangeInfo.livecast_id, function (data) {
      chartsOp.mvp = {
    ...
    $(".d_countryBox").find('label:odd').text(teamInfo.Team2);
    $(".d_countryBox").find('label:even').text(teamInfo.Team1);
  ...
  $(".lb_historyCountrys").find('input').click(function () { 
    
    if(this.value==0){
      $(".d_l3_homeBox").show().siblings('div').hide();
    }else{
      $(".d_l3_guestBox").show().siblings('div').hide();
			$('#d_chooseGnear').find('input:last').trigger('click');
    }
   });
     $(".d_futureCountrys").find('input').click(function () { 
    if(this.value==0){
      $(".d_l4_homeBox").show().siblings('div').hide();
    }else{
      $(".d_l4_guestBox").show().siblings('div').hide();
    }
   });
    $(".lb_newsCountrys").find('input').click(function () { 
    if(this.value==0){
      $(".d_l5_newsHome").show().siblings('dl').hide();
    }else{
      $(".d_l5_newsGuest ").show().siblings('dl').hide();
    }
   })
